...
const Features = () => {
  ...
  return (
        <div id='features' className="flex flex-col items-center my-10 scroll-mt-12">
            ...
            <Title title="Crea tu CV" description="de forma rápida y sencilla con nuestra herramienta intuitiva de IA." />
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Datos en tiempo real</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Nos adaptamos a tus datos para mostrarlos de la forma mas eficaz posible</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">100% Personalizable</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Tu perfil, tus ideas, tu manera de expresarte</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Descargas Gratis</h3>
                                    <p className="text-sm text-slate-600 max-w-xs">Descarga tu CV en distintos formatos sin costo alguno</p>
                                </div>
                            </div>
                    </div>
                </div>
